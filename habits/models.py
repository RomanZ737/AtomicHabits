...
class Habit(models.Model):
    ...
    name = models.CharField(
        max_length=100, verbose_name="Habit name", help_text="Название привычки"
    )
    habit_location = models.CharField(
        max_length=100,
    ...
    time_for_action = models.IntegerField(
        verbose_name="Habit Time For Action", help_text="Время на выполнение привычки"
    )
